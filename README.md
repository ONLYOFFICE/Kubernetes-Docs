...
| `upgrade.job.image.tag`                                     | Job by upgrade image tag                                                                                                                                                       | `9.0.4-1`                                                                                 |
...
| `rollback.job.image.tag`                                    | Job by rollback image tag                                                                                                                                                      | `9.0.4-1`                                                                                 |
...
| `delete.job.image.tag`                                      | Job by delete image tag                                                                                                                                                        | `9.0.4-1`                                                                                 |
...
| `install.job.image.tag`                                     | Job by pre-install ONLYOFFICE Docs image tag                                                                                                                                   | `9.0.4-1`                                                                                 |
...
| `clearCache.job.image.tag`                                  | Job by Clear Cache ONLYOFFICE Docs image tag                                                                                                                                   | `9.0.4-1`                                                                                 |
