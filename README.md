...
| example.requests.memory             | memory request                                                                                                           | 128Mi                                      |
| example.requests.cpu                | cpu request                                                                                                              | 100m                                       |
| example.limits.memory               | memory limit                                                                                                             | 128Mi                                      |
| example.limits.cpu                  | cpu limit                                                                                                                | 250m                                       |
