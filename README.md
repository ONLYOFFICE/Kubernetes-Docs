...
| jwt.enabledInbox                      | Specifies the enabling the JWT validation only for inbox requests. If not specified, the value of the `jwt.enabled` parameter is used  | ""                                         |
| jwt.enabledOutbox                     | Specifies the enabling the JWT validation only for outbox requests. If not specified, the value of the `jwt.enabled` parameter is used | ""                                         |
...
| jwt.secretInbox                       | Defines the secret key to validate the JWT for inbox requests only. If not specified, the value of the `jwt.secret` parameter is used  | ""                                         |
| jwt.secretOutbox                      | Defines the secret key to validate the JWT for outbox requests only. If not specified, the value of the `jwt.secret` parameter is used | ""                                         |
...
| jwt.headerInbox                       | Defines the http header that will be used only for inbox requests. If not specified, the value of the `jwt.header` parameter is used   | ""                                         |
| jwt.headerOutbox                      | Defines the http header that will be used only for outbox requests. If not specified, the value of the `jwt.header` parameter is used  | ""                                         |
