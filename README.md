...
|-----------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|
| `connections.dbHost`                    | IP address or the name of the database host                                                                                            | `postgresql`                                 |
...
| `connections.amqpType`                  | Defines the message broker type. Possible values are `rabbitmq` or `activemq`                                                          | `rabbitmq`                                   |
...
| `connections.amqpUser`                  | message broker user                                                                                                                    | `user`                                       |
| `connections.amqpProto`                 | message broker protocol                                                                                                                | `amqp`                                       |
| `connections.amqpPassword`              | message broker user password. If set to, it takes priority over the `connections.amqpExistingSecret`                                   | `""`                                         |
...
| `jwt.inbox`                             | JSON Web Token validation parameters for inbox requests only. If not specified, the values of the `jwt` parameters are used            | `{}`                                         |
| `jwt.outbox`                            | JSON Web Token validation parameters for outbox requests only. If not specified, the values of the `jwt` parameters are used           | `{}`                                         |
