...
| `docservice.containerImage`             | docservice container image name                                                                                                        | `onlyoffice/docs-docservice-de:7.0.1-1`      |
...
| `proxy.proxyContainerImage`             | docservice proxy container image name                                                                                                  | `onlyoffice/docs-proxy-de:7.0.1-1`           |
...
| `converter.containerImage`              | converter container image name                                                                                                         | `onlyoffice/docs-converter-de:7.0.1-1`       |
