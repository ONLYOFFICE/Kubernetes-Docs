...
| jwt.inbox.enabled                     | Specifies the enabling the JWT validation only for inbox requests. If not specified, the value of the `jwt.enabled` parameter is used  |                                            |
| jwt.outbox.enabled                    | Specifies the enabling the JWT validation only for outbox requests. If not specified, the value of the `jwt.enabled` parameter is used |                                            |
...
| jwt.inbox.secret                      | Defines the secret key to validate the JWT for inbox requests only. If not specified, the value of the `jwt.secret` parameter is used  | ""                                         |
| jwt.outbox.secret                     | Defines the secret key to validate the JWT for outbox requests only. If not specified, the value of the `jwt.secret` parameter is used | ""                                         |
...
| jwt.inbox.header                      | Defines the http header that will be used only for inbox requests. If not specified, the value of the `jwt.header` parameter is used   | ""                                         |
| jwt.outbox.header                     | Defines the http header that will be used only for outbox requests. If not specified, the value of the `jwt.header` parameter is used  | ""                                         |
