...
| `example.image.tag`                                         | Example container image tag                                                                                                                                                    | `7.2.0-1`                                                                                 |
...
| `docservice.image.tag`                                      | Docservice container image tag                                                                                                                                                 | `7.2.0-1`                                                                                 |
...
| `proxy.image.tag`                                           | Docservice Proxy container image tag                                                                                                                                           | `7.2.0-1`                                                                                 |
...
| `converter.image.tag`                                       | Converter container image tag                                                                                                                                                  | `7.2.0-1`                                                                                 |
...
| `upgrade.job.image.tag`                                     | Job by upgrade image tag                                                                                                                                                       | `7.2.0-1`                                                                                 |
...
| `rollback.job.image.tag`                                    | Job by rollback image tag                                                                                                                                                      | `7.2.0-1`                                                                                 |
...
| `delete.job.image.tag`                                      | Job by delete image tag                                                                                                                                                        | `7.2.0-1`                                                                                 |
...
| `install.job.image.tag`                                     | Job by pre-install ONLYOFFICE Docs image tag                                                                                                                                   | `7.2.0-1`                                                                                 |
