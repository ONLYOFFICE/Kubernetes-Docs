...
Alternatively, you can use the `nonroot-v2` `SecurityContextConstraints` policy in commonAnnotations or annotations for all resources describing the podTemplate, make sure that the user has permission to use this scc via `oc adm policy who-can use scc nonroot-v2`.
