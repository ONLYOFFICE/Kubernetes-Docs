...
| `docservice.image.repository`                               | Docservice container image repository. This image repository is kept for backward compatibility. You can use `docker.io/onlyoffice/docs-cluster-de` instead*                             | `docker.io/onlyoffice/docs-docservice-de`                                                           |
...
| `proxy.image.repository`                                    | Docservice Proxy container image repository. This image repository is kept for backward compatibility. You can use `docker.io/onlyoffice/docs-cluster-de` instead*                       | `docker.io/onlyoffice/docs-proxy-de`                                                                |
...
| `converter.image.repository`                                | Converter container image repository. This image repository is kept for backward compatibility. You can use `docker.io/onlyoffice/docs-cluster-de` instead*                              | `docker.io/onlyoffice/docs-converter-de`                                                            |
...
| `adminpanel.image.repository`                               | Admin panel container image repository. This image repository is kept for backward compatibility. You can use `docker.io/onlyoffice/docs-cluster-de` instead*                              | `docker.io/onlyoffice/docs-adminpanel-de`                                                         |
...
| `example.image.repository`                                  | Example container image name                                                                                                                                                   | `docker.io/onlyoffice/docs-example`                                                                 |
...
| `upgrade.job.image.repository`                              | Job by upgrade image repository                                                                                                                                                | `docker.io/onlyoffice/docs-utils`                                                                   |
...
| `rollback.job.image.repository`                             | Job by rollback image repository                                                                                                                                               | `docker.io/onlyoffice/docs-utils`                                                                   |
...
| `delete.job.image.repository`                               | Job by delete image repository                                                                                                                                                 | `docker.io/onlyoffice/docs-utils`                                                                   |
...
| `install.job.image.repository`                              | Job by pre-install ONLYOFFICE Docs image repository                                                                                                                            | `docker.io/onlyoffice/docs-utils`                                                                   |
...
| `clearCache.job.image.repository`                           | Job by Clear Cache ONLYOFFICE Docs image repository                                                                                                                            | `docker.io/onlyoffice/docs-utils`                                                                   |
...
| `grafanaDashboard.job.image.repository`                     | Job by Grafana Dashboard ONLYOFFICE Docs image repository                                                                                                                      | `docker.io/onlyoffice/docs-utils`                                                                   |
...
| `wopiKeysGeneration.job.image.repository`                   | Job by Wopi Keys Generation ONLYOFFICE Docs image repository                                                                                                                   | `docker.io/onlyoffice/docs-utils`                                                                   |
...
| `wopiKeysDeletion.job.image.repository`                     | Job by Wopi Keys Deletion ONLYOFFICE Docs image repository                                                                                                                     | `docker.io/onlyoffice/docs-utils`                                                                   |
...
| `customResources.job.image.repository`                      | Job by Custom Resources ONLYOFFICE Docs image repository*                                                                                                                       | `docker.io/onlyoffice/docs-cluster-de`                                                              |
...
| `tests.image.repository`                                    | Test container image name                                                                                                                                                      | `docker.io/onlyoffice/docs-utils`                                                                   |
