...
| `install.job.image.repository`                              | Job by pre-install ONLYOFFICE Docs image repository. If `privateCluster=true` is set, the image must have `wget` and `psql` installed                                          | `postgres`                                                                                |
| `install.job.image.tag`                                     | Job by pre-install ONLYOFFICE Docs image tag                                                                                                                                   | `latest`                                                                                  |
