...
| `upgrade.job.image.repository`                              | Job by upgrade image repository                                                                                                               | `postgres`                                   |
...
| `upgrade.existingConfigmap.dsStop`                          | The name of the existing ConfigMap that contains the ONLYOFFICE Docs upgrade script. If set, the four previous parameters are ignored                                    | `"`                                          |
