...
| `docservice.image.tag`                                      | Docservice container image tag                                                                                                                                                 | `8.0.0-1`                                                                                 |
...
| `proxy.image.tag`                                           | Docservice Proxy container image tag                                                                                                                                           | `8.0.0-1`                                                                                 |
...
| `converter.image.tag`                                       | Converter container image tag                                                                                                                                                  | `8.0.0-1`                                                                                 |
...
| `example.image.tag`                                         | Example container image tag                                                                                                                                                    | `8.0.0-1`                                                                                 |
...
| `grafana.ingress.annotations`                               | Map of annotations to add to Grafana Ingress                                                                                                                                   | `nginx.ingress.kubernetes.io/proxy-body-size: 100m`                                       |
...
| `upgrade.job.image.tag`                                     | Job by upgrade image tag                                                                                                                                                       | `8.0.0-1`                                                                                 |
...
| `rollback.job.image.tag`                                    | Job by rollback image tag                                                                                                                                                      | `8.0.0-1`                                                                                 |
...
| `delete.job.image.tag`                                      | Job by delete image tag                                                                                                                                                        | `8.0.0-1`                                                                                 |
...
| `install.job.image.tag`                                     | Job by pre-install ONLYOFFICE Docs image tag                                                                                                                                   | `8.0.0-1`                                                                                 |
...
| `tests.image.tag`                                           | Test container image tag                                                                                                                                                       | `8.0.0-1`                                                                                 |
